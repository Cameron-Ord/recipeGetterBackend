...
INSERT INTO `AdminSession` VALUES (1,1,'592bd57a74344f198342018c671f0a40');
...
/*!50003 SET collation_connection  = utf8mb4_unicode_ci */ ;
DELIMITER ;;
CREATE DEFINER=`Cameron`@`localhost` PROCEDURE `createRecipe`(titleInput varchar(255), descInput varchar(255), imageInput varchar(250), ingredientInput varchar(500), isHealthyInput BOOL, cuisineInput varchar(255), tokenInput varchar(500))
    MODIFIES SQL DATA
BEGIN
...
-- Dump completed on 2023-10-02 16:03:35
